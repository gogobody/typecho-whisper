...
function threadedComments($comments, $options)
{
    ...
    if ($options->fields->enable_comment == '0'){
            ...
            <div class="foot">
                <div class="count"><?php
                    ...
                    <span class="iconfont <?php echo $ua->returnTimeUa()['icon'] ?>">
                        <?php echo "发自" . $ua->returnTimeUa()['title'];?></div>
                <div class="action">
...
<!--                    </div>-->
        ...
        <?php if ($enable_comment) : ?>
            <form no-pjax class="reply j-dynamic-reply" action="<?php _e($options->commentUrl); ?>" method="post" >
                ...
                <div class="head">
                    ...
                    <input autocomplete="off" placeholder="网址（选填）" type="text" name="url" value="<?php $options->class->remember('url'); ?>">
